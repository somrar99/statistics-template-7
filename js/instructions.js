...
addMdToPage(`
  ...
  ### Instruktioner
  * 1. Det finns mycket du kan undersöka här!
  * 2. T.ex. röstar folk olika i olika delar av landet? Den exakta geografiska datan gör att du kan arbeta med olika indelningar (väst, öst, norr, söder, mitten).
  * 3. Du kan även dela in data efter län för lite större områden än kommuner. Då måste du aggregera data (t.ex.) valresultat för alla kommuner som ingår i ett visst län!
  * 4. Finns det skillnader i hur folk röstar i kommuner med hög respektive låg medelinkomst.
  * 5. Finns det några större skillnader i medelålder mellan olika kommuner. Kan detta knytas till större områden? Bor det yngre människor i söder än i norr?
  * 6. Verkar folktäthet (männniskor/kvadratkilometer) ha betydelse för hur man röstar?
  * 7. Verkar medelålder i ett visst område ha betydelse för man röstar?
  * 8. Går det att hitta faktorer som verkar påverka hur högt valdeltagande det finns på olika platser?
